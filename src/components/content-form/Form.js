...
function FormContent() {
  ...
  const getCategories = (e) => {
    axios
      .get(`https://lossantos-api.herokuapp.com/api/category`)
      .then((res) => {
  ...
  const getSubCategories = (e) => {
    axios
      .get(`https://lossantos-api.herokuapp.com/api/subcategory`)
      .then((res) => {
  ...
  const getClassifications = (e) => {
    axios
      .get(`https://lossantos-api.herokuapp.com/api/classification`)
      .then((res) => {
        // console.log(res.data)
  ...
  const getCompanies = (e) => {
    axios
      .get(`https://lossantos-api.herokuapp.com/api/company`)
      .then((res) => {
        // console.log(res.data)
  ...
  const Submit = (e) => {
    ...
    axios({
      ...
      .then((res) => {
        // console.log(res.data);
        SetSavedConten(res.data);
        window.localStorage.setItem(
          'SavedContent' , JSON.stringify(res.data)
        )
  ...
  const uploadImage = () => {
    const savedC = JSON.parse(localStorage.getItem("SavedContent"));
    if (!file) {
    ...
    fetch(
      "https://lossantos-api.herokuapp.com/api/uploads/content/" +
      savedC.uid,
      {
        method: "PUT",
        body: formData,
  ...
  return (
    <>
      ...
      <Form>
        ...
        <Row className="mb-3 mt-3">
          <Form.Group as={Col} controlId="formGridState">
            ...
            <div className="right mt-1">
              <Button className="comment-icon editable" href="/edit-category">
        ...
        <Row className="mb-3">
          ...
          <Form.Group as={Col} controlId="formGridSubtitlle">
            ...
            <Form.Control
              type="number"
              placeholder="Enter minutes total"
        ...
        <div className="right">
          <Button
            variant="primary"
            className="button submit margin"
            onClick={Submit}
          >
            ADD CONTENT
          </Button>
      ...
      <Row>
        <Title title="Avatar" class="title" />
        <hr></hr>
      </Row>
